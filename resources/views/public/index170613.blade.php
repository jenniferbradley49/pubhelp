...
//				doOnShowGenre(true);
			...
			// multiple response, should not proceed upon change						
//			$('input:radio[name=format]').change(function(){
//				doOnShowFormat('format', true);
//			}); 

			$('#show_format_next').click(function(){
//				alert('show format next button pressed');
...
//next several lines have been replaced by showTab, 
