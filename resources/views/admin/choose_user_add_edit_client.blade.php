...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Add client for this user') }}</div>
				
	<div class="col-lg-1">{{ Form::radio('str_choice', 'add', false) }}</div>
...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Edit client for this user') }}</div>
				
	<div class="col-lg-1">{{ Form::radio('str_choice', 'edit', true) }}</div>
