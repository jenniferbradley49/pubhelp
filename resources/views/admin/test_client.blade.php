...
<!-- resources/views/admin/test_client.blade.php -->
        ...
        <div class="row">
            ...
            {{ Form::hidden('int_client_id', $data['int_client_id']) }}                    
        ...
        <div class="row">  
            ...
            <div class="col-lg-6">
                       {{  $data['str_lead_destination_last'] }}                    
						<br>
            </div>
            <div class="col-lg-1">&nbsp;
            </div>
        ...
        <div class="row">  
            ...
            <div class="col-lg-6">
                       {{ Form::text('str_lead_destination_tested', $data['str_lead_destination_tested'], array('class' => "form-control", 'id' => 'str_lead_destination_tested', 'placeholder' => 'enter modified lead destination here')) }}                    
						<br>
            </div>
            <div class="col-lg-1">&nbsp;
            </div>
        ...
        <div class="row">  
            ...
            <div class="col-lg-6">
                       {{ Form::text('str_test_id', $data['str_test_id'], array('class' => "form-control", 'id' => 'str_test_id', 'placeholder' => 'enter test ID here')) }}                    
						<br>
            </div>
            <div class="col-lg-1">&nbsp;
            </div>
