...
<div class="col-sm-1"> <br><br><br></div>
<div class="col-sm-3"> 
   {{ Form::label('int_survey_item_id', 'Choose the item') }}            
    </div>
<div class="col-sm-5">
   {{ Form::select('int_survey_item_id', $data['arr_items']) }}
</div>
...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Edit this item') }}</div>
...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Delete this item') }}</div>
