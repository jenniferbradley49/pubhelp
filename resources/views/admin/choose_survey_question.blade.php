...
@foreach ($data['existing_questions'] as $question)
...
<div class="col-sm-1"> <br><br><br></div>
<div class="col-sm-3"> 
   {{ Form::label('survey_question_id', 'Choose the title of the question') }}            
    </div>
<div class="col-sm-5">
   {{ Form::select('survey_question_id', $data['arr_questions']) }}
</div>
...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Manipulate item for this question') }}</div>
...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Add item for this question') }}</div>
...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Edit this question') }}</div>
...
<div class="row">		
	...
	<div class="col-lg-5">{{ Form::label('str_choice', 'Delete this question') }}</div>
